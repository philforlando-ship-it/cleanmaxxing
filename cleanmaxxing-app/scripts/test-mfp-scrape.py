...
Why: python-myfitnesspal hasnt had a major release in over a year.
...
Output: todays totals (calories + macros) for the configured account,
...
librarys wheels may not cover 3.14 yet.
"""
...
def main() -> int:
    ...
    try:
        ...
        print(
            "ERROR: python-myfitnesspal not installed. Run:\n"
            "    pip install python-myfitnesspal",
            file=sys.stderr,
        )
        return 1
