// POST /api/plan/pattern-d/trt/intervention/[id]/end
// User pressed "I've stopped TRT" on the Off-ramp surface. Flips
// status='off' and stamps ended_at via setInterventionStatus, which
// also re-syncs the legacy current_interventions[] array (drops trt
// from it).
...
export async function POST(
  ...
  try {
    ...
    console.error('trt_intervention_end_failed', err);
