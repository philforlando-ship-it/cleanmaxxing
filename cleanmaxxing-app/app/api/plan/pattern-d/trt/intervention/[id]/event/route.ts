// POST /api/plan/pattern-d/trt/intervention/[id]/event
// Log a side effect / lab result / dose change / check-in / note
// against a TRT intervention. Confirms the parent intervention
// belongs to the user AND is type='trt' before writing.
...
export async function POST(
  ...
  try {
    ...
    console.error('trt_event_create_failed', err);
    return NextResponse.json(
