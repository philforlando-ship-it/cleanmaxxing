// DELETE /api/plan/pattern-d/trt/event/[id]
// Remove an event row. RLS gates ownership; we additionally guard
// that the parent intervention is of type='trt' so this route can't
// delete events on hair / GLP-1 / etc. through cross-route abuse.
...
export async function DELETE(
  ...
  try {
    ...
    console.error('trt_event_delete_failed', err);
    return NextResponse.json(
