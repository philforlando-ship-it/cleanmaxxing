// DELETE /api/plan/pattern-d/peptides/event/[id]
// Remove an event row. RLS gates ownership; we additionally guard
// that the parent intervention is of type='peptide' so this route
// can't delete events on hair / TRT / GLP-1 / etc. through cross-
// route abuse.
...
export async function DELETE(
  ...
  try {
    ...
    console.error('peptide_event_delete_failed', err);
    return NextResponse.json(
