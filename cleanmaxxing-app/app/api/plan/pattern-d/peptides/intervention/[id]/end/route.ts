// POST /api/plan/pattern-d/peptides/intervention/[id]/end
// User pressed "I've stopped the peptide protocol" on the Off-ramp
// surface. Flips status='off' and stamps ended_at via
// setInterventionStatus, which also re-syncs the legacy
// current_interventions[] array (drops peptide from it).
...
export async function POST(
  ...
  try {
    ...
    console.error('peptide_intervention_end_failed', err);
