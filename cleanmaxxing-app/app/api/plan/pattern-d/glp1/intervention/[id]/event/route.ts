// POST /api/plan/pattern-d/glp1/intervention/[id]/event
// Log a side effect / lab result / dose change / check-in / note
// against a GLP-1 intervention. Confirms the parent intervention
// belongs to the user AND is type='glp1' before writing.
...
export async function POST(
  ...
  try {
    ...
    console.error('glp1_event_create_failed', err);
    return NextResponse.json(
