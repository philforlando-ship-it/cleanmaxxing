// PATCH /api/plan/pattern-d/glp1/intervention/[id]
// Edit dose / frequency / titration_schedule / prescriber_status /
// notes. RLS prevents cross-user updates; we also re-check ownership
// at the type filter so a user can't edit non-glp1 rows through this
// route.
//
// DELETE /api/plan/pattern-d/glp1/intervention/[id]
...
export async function PATCH(
  ...
  try {
    ...
    console.error('glp1_intervention_update_failed', err);
    return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    console.error('glp1_intervention_delete_failed', err);
    return NextResponse.json(
