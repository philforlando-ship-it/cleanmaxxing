// /today tile for the skincare plan. Server component — same shape
// as the other Pattern A plan cards. Two states: pending CTA / done
// quiet link. Parent gates on focus_areas.includes('skin').
...
export function SkincarePlanCard({ state }: Props) {
  if (state === 'done') {
    return (
  ...
  return (
    <section className="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
      <h2 className="text-lg font-medium">Get your skincare plan</h2>
      <p className="mt-2 text-[14px] leading-relaxed text-zinc-700 dark:text-zinc-300">
        ...
        address, and what you&rsquo;re currently doing. Mister P writes
        you a short, specific plan. About five minutes.
      </p>
      <div className="mt-4">
        <Link
          href="/plan/skincare"
