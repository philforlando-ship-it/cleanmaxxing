// /today tile for the facial hair plan. Server component — same shape
// as HairPlanCard / StylePlanCard. Two states: pending CTA / done quiet
// link. Parent (today/page.tsx) gates on focus_areas including
// 'grooming'.
...
export function FacialHairPlanCard({ state }: Props) {
  if (state === 'done') {
    return (
  ...
  return (
    <section className="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
      <h2 className="text-lg font-medium">Get your facial hair plan</h2>
      <p className="mt-2 text-[14px] leading-relaxed text-zinc-700 dark:text-zinc-300">
        Four short questions about what you have, how it grows in, and where
        you want to take it. Mister P writes you a short, specific plan.
        About five minutes.
      </p>
      <div className="mt-4">
        <Link
