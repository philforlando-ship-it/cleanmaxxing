// /today tile for the cardio plan. Server component. Two states:
// pending CTA / done quiet link. Parent gates on
// focus_areas.includes('fitness') — same gate as the strength plan.
...
export function CardioPlanCard({ state }: Props) {
  if (state === 'done') {
    return (
  ...
  return (
    <section className="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
      <h2 className="text-lg font-medium">Get your cardio plan</h2>
      <p className="mt-2 text-[14px] leading-relaxed text-zinc-700 dark:text-zinc-300">
        Four short questions about your role for cardio, current movement,
        modality, and days available. Mister P writes a specific plan
        grounded in Zone 2 + step count + occasional HIIT — no overtraining,
        no chasing calories burned. About five minutes.
      </p>
      <div className="mt-4">
        <Link
          href="/plan/cardio"
