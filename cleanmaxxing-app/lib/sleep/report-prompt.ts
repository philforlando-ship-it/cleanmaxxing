...
- **Facial definition cross-link (POV 16)**: when rolling_count is >= 3 AND rolling_avg_hours is < 6.5, OR primary_concerns includes 'wake_up_tired', add ONE sentence — not a sub-section — naming that the puffiness and softer facial definition users notice in the mirror after a poor week is the inflammation and water-retention cost of underslept nights. Frame it as "the cheapest face-definition lever you have is the sleep prescription you're already getting." Then return to the sleep plan. Skip when sleep is fine.
